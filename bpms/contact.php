...
<html lang="en">
  <head>
    <title>Seema Beauty Parlour-Contact us</title>
...
?>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p>Sainik Colony, Jammu, Jammu & Kashmir</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel://1234567920">+91 70062 93832</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="mailto:info@yoursite.com">seemabeautyparlour0000@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p>8:00 to 20:00 except Tuesday's</p>
	          </div>
          </div>
          <?php } ?>
        </div>
